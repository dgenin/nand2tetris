...
(* OASIS_START *)
(* DO NOT EDIT (digest: 380e10d4cc24233d3e7db7543aadf5cb) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("compeng", None);
                           FindlibPackage ("vmwriter", None);
                           FindlibPackage ("symtab", None);
                           FindlibPackage ("parser", None);
     ...
     oasis_digest = Some "\160GZ\194\156Qu'\015\143\167\147\196\238\143\191";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
