...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75ca54f64d9c7e475b17f7b75ed9a16e) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["class.jack"]))];
          ...
          ("constructor",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["constructor.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("statement",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["statement.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("parenthesis",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["parenthesis.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("array",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["array.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("array_assignment",
          ...
          ("subcall",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["subcall.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("methcall",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["methcall.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("ifelse",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["ifelse.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("while",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["while.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("return",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["return.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("comment",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$jc", ["comment.jack"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          authors =
            [
               "Ilya Chukhman <ilya.chukhman@gmail.com> and Dan Genin <dan.genin@gmail.com>"
            ];
          homepage = None;
          bugreports = None;
          ...
          description =
            Some
              [OASISText.Para "Allows parsing and executing Jack programs"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "vmwriter";
                           InternalLibrary "symtab";
                   ...
                   {exec_custom = false; exec_main_is = "jc.ml"});
               Test
                 ({
                     cs_name = "class";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; InternalExecutable "jc"]
                   });
               Test
                 ({
                     cs_name = "constructor";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\029\023\218\022,V\172>\141X\t\182R&\\s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
