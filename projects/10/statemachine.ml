...
let global_sm =
      ...
      let statement_sm = [
                      ...
                      (*1*) [((Lident("*"), Lsymbol("[")), (3,3)); ((Lident("*"), Lany), (3,5))];
                      (*2*) [((Lsymbol(";"), Lany)), (3,7)];
      ...
      (*4*)
      let expr_sm = [ (*0*) [((Lsymbol("-"), Lany), (3,0)); ((Lsymbol("~"), Lany), (3,0)); ((Lkeyword("true"), Lany), (3,1));
                             ((Lkeyword("false"), Lany), (3,1)); ((Lkeyword("null"), Lany), (3,1)); ((Lkeyword("this"), Lany), (3,1));
                             ((Lint(0), Lany), (3,1)); ((Lkeyword("null"), Lany), (3,1)); ((Lkeyword("this"), Lany), (3,1))
                             ];
                      (*1*) [((Lident("*"), Lany), (2,2))];
                      (*2*) [((Lsymbol("("), Lany), (2,3))];
                      (*3*) [((Lkeyword("char"), Lany), (2,4)); ((Lkeyword("int"), Lany), (2,4)); ((Lkeyword("boolean"), Lany), (2,4)); ((Lsymbol(")"), Lany), (2, 6))];
      ...
      let term_sm = [ (*0*) [((Lop('-'), Lany), (5,0)); ((Lsymbol("~"), Lany), (5,0));
                      ...
                      (*6*) (*Done*) ] in
      (*6*)
      let op_sm = [ (*0*) [((Lident("*"), Lsymbol("(")), (-1,-1)); ((Lident("*"), Lsymbol("[")), (-1,-1)); ((Lident("*"), Lany), (5,5)); ((Lsymbol("("), Lany), (4,0)); ((Lsymbol("-"), Lany), (5,0)); ((Lsymbol("~"), Lany), (5,0))];
                      (*1*) [((Lident(")"), Lany), (5,5))];
                      (*2*) [((Lany, Lany), (-1,-1))];
                      (*3*) [((Lany, Lany), (-1,-1))];
                      (*4*) [((Lany, Lany), (-1,-1))];
